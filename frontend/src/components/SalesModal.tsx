          ...
          >
            ...
            <Stack mt={3}>
              ...
              <Stack width={"384px"} display={"flex"} gap={2}>
                ...
                <Typography width={"100%"} style={styleIngre}>
                  {selectedFood.ingredient}
                </Typography>
                <Typography width={"100%"} style={mediumWords}>
                  Too
                </Typography>
                <Stack
                  mt={2}
                ...
                >
                  <Button style={buttonStyle} onClick={decreaseCount}>
                    -
                  </Button>
                  <Typography style={countStyle}>{count}</Typography>
                  <Button style={buttonStyle} onClick={increaseCount}>
                    +
                  </Button>
                </Stack>
                <Button onClick={navigateToBasket} style={styleBasket}>
                  Сагслах
                </Button>
              </Stack>
            </Stack>
